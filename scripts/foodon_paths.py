...
FOODON_EMBED_DIR = ROOT / "scratch" / "foodon_embed"
FOODON_MAPPING_PARQUET = ROOT / "scratch" / "tag" / "fdc_foodon_mapping.parquet"
FOODON_MAPPING_CSV = ROOT / "scratch" / "tag" / "fdc_foodon_mapping.csv"
FOODON_CONTAINS_PARQUET = ROOT / "scratch" / "tag" / "foodon_contains.parquet"
FOODON_CONTAINS_CSV = ROOT / "scratch" / "tag" / "foodon_contains.csv"
FOODON_CONTAINS_SUMMARY = ROOT / "scratch" / "tag" / "foodon_contains_summary.json"
